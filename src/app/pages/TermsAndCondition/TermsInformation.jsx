...
const TermsInformation = () => {
  return (
    <div className='flex flex-col w-full px-10 lg:w-[65%]  gap-10 mb-20 '>
          <div className='flex items-center justify-center text-center flex-col m-20 gap-5'>
          ...
          <ol className='flex flex-col gap-10'>
            ...
            <div key={t.title} className='flex flex-col gap-5'>
              ...
              )) : <p className='text-[14px] md:text-[16px] list-decimal  font-light'>{t.content}</p>}
              </ol>
            </div>
          ))}
          </ol>
