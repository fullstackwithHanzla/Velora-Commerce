...
const SignUpMethods = memo(({  method , children , icon}) => {
  ...
  return (
    <button onClick={()=>handleSignUpMethod(`Authentication with ${method} is not implemented yet`,"info")} className='flex border border-gray-600/20 rounded-md items-center justify-center  grow py-2 gap-2 bg-gray-300/5 hover:bg-gray-300/15'>
