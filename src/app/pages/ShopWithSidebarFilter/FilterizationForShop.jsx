...
const FilterizationForShop = () => {
  ...
  return (
    <div className="fixed  inset-0 w-screen z-20 pointer-events-none">
      ...
      <div
        className={`
          absolute left-0 top-0 flex flex-col min-h-screen h-full  w-full  xs:w-100 md:w-80
          bg-[#f0f0f0]
          ...
          <div>
            ...
            <div className="overflow-y-scroll flex p-4 flex-col gap-5">
                ...
                <div className="flex items-center justify-between bg-white rounded-md p-3.5">
                    ...
                    <span className="text-(--accent-secondary) cursor-pointer hover:text-blue-600">Clean All</span>
                </div>

                <div className="flex flex-col  bg-white rounded-md">
                    <div onClick={() => setcategoryDropDown((prev) => !prev)} className={`flex items-center  p-3.5 justify-between ${categoryDropDown? "border-b border-gray-600/20":""}`}>
                        <span>Category</span>
                ...
                <div className="flex flex-col  bg-white rounded-md">
                              <div onClick={() => setcolorsDropDown((prev) => !prev)} className={`flex items-center  p-3.5 justify-between ${colorsDropDown ? "border-b border-gray-600/20":""}`}>
                        <span>Colors</span>
                ...
                <div className="flex flex-col  bg-white rounded-md">
                              <div onClick={() => setpriceDropDown((prev) => !prev)} className={`flex items-center  p-3.5 justify-between ${priceDropDown ? "border-b border-gray-600/20":""}`}>
                        <span>Price</span>
                                  <FaAngleDown className={`text-gray-600 transition-all duration-300 ease-in-out ${priceDropDown ? "": "rotate-180"}`}/>
                    </div>
                    
                              <PriceDropDown priceDropDown={priceDropDown}/>
                </div>
